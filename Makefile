...
bin/program: bin/ src/main.cpp src/ILight.cpp src/FakeLight.cpp src/ILight.cpp src/LightController.cpp src/NCursesGui.cpp src/AlarmStateMachine.cpp src/LightStateMachine.cpp src/lib/TimeTools.cpp src/LightBlinker.cpp
